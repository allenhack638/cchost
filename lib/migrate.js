...
// Only projects/ holds the resumable conversation transcripts. sessions/ is transient
// per-process state and is intentionally not migrated.
const SUBDIRS = ['projects'];
